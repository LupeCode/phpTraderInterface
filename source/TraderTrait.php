...
trait TraderTrait
{
    ...
    static $TRADER_MA_TYPE_SMA                   = 0;
    static $TRADER_MA_TYPE_EMA                   = 1;
    static $TRADER_MA_TYPE_WMA                   = 2;
    static $TRADER_MA_TYPE_DEMA                  = 3;
    static $TRADER_MA_TYPE_TEMA                  = 4;
    static $TRADER_MA_TYPE_TRIMA                 = 5;
    static $TRADER_MA_TYPE_KAMA                  = 6;
    static $TRADER_MA_TYPE_MAMA                  = 7;
    static $TRADER_MA_TYPE_T3                    = 8;
    static $TRADER_REAL_MIN                      = -3.0000000000000002E+37;
    static $TRADER_REAL_MAX                      = 3.0000000000000002E+37;
    static $TRADER_FUNC_UNST_ADX                 = 0;
    static $TRADER_FUNC_UNST_ADXR                = 1;
    static $TRADER_FUNC_UNST_ATR                 = 2;
    static $TRADER_FUNC_UNST_CMO                 = 3;
    static $TRADER_FUNC_UNST_DX                  = 4;
    static $TRADER_FUNC_UNST_EMA                 = 5;
    static $TRADER_FUNC_UNST_HT_DCPERIOD         = 6;
    static $TRADER_FUNC_UNST_HT_DCPHASE          = 7;
    static $TRADER_FUNC_UNST_HT_PHASOR           = 8;
    static $TRADER_FUNC_UNST_HT_TRENDLINE        = 10;
    static $TRADER_FUNC_UNST_HT_TRENDMODE        = 11;
    static $TRADER_FUNC_UNST_KAMA                = 12;
    static $TRADER_FUNC_UNST_MAMA                = 13;
    static $TRADER_FUNC_UNST_MFI                 = 14;
    static $TRADER_FUNC_UNST_MINUS_DI            = 15;
    static $TRADER_FUNC_UNST_MINUS_DM            = 16;
    static $TRADER_FUNC_UNST_NATR                = 17;
    static $TRADER_FUNC_UNST_PLUS_DI             = 18;
    static $TRADER_FUNC_UNST_PLUS_DM             = 19;
    static $TRADER_FUNC_UNST_RSI                 = 20;
    static $TRADER_FUNC_UNST_STOCHRSI            = 21;
    static $TRADER_FUNC_UNST_T3                  = 22;
    static $TRADER_FUNC_UNST_ALL                 = 23;
    static $TRADER_FUNC_UNST_NONE                = -1;
    static $TRADER_COMPATIBILITY_DEFAULT         = 0;
    static $TRADER_COMPATIBILITY_METASTOCK       = 1;
    static $TRADER_ERR_SUCCESS                   = 0;
    static $TRADER_ERR_LIB_NOT_INITIALIZE        = 1;
    static $TRADER_ERR_BAD_PARAM                 = 2;
    static $TRADER_ERR_ALLOC_ERR                 = 3;
    static $TRADER_ERR_GROUP_NOT_FOUND           = 4;
    static $TRADER_ERR_FUNC_NOT_FOUND            = 5;
    static $TRADER_ERR_INVALID_HANDLE            = 6;
    static $TRADER_ERR_INVALID_PARAM_HOLDER      = 7;
    static $TRADER_ERR_INVALID_PARAM_HOLDER_TYPE = 8;
    static $TRADER_ERR_INVALID_PARAM_FUNCTION    = 9;
    static $TRADER_ERR_INPUT_NOT_ALL_INITIALIZE  = 10;
    static $TRADER_ERR_OUTPUT_NOT_ALL_INITIALIZE = 11;
    static $TRADER_ERR_OUT_OF_RANGE_START_INDEX  = 12;
    static $TRADER_ERR_OUT_OF_RANGE_END_INDEX    = 13;
    static $TRADER_ERR_INVALID_LIST_TYPE         = 14;
    static $TRADER_ERR_BAD_OBJECT                = 15;
    static $TRADER_ERR_NOT_SUPPORTED             = 16;
    static $TRADER_ERR_INTERNAL_ERROR            = 5000;
    static $TRADER_ERR_UNKNOWN_ERROR             = 65535;
